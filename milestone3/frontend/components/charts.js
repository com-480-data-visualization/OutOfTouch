...
export async function loadSpiralChart() {
    ...
    const data = await d3.csv("../assets/data/crashes_spiral.csv");
    console.log(data);
    ...
    function draw() {
        ...
        svg.append('text')
            .attr('x', width / 2)
            .attr('y', height / 2 + zeroRadius + 16)
            .attr('fill', '#fff')
            .attr('text-anchor', 'middle')
            .attr('alignment-baseline', 'middle')
            .attr('font-size', 16)
            .text(`${minAnomaly.toFixed(2)}`);
        ...
        svg.append('text')
            .attr('x', width / 2)
            .attr('y', height / 2 + oneRadius + 16)
            .attr('fill', '#fff')
            .attr('text-anchor', 'middle')
            .attr('alignment-baseline', 'middle')
            .attr('font-size', 16)
            .text(`${maxAnomaly.toFixed(2)}`);
