        ...
        _cc(h, [
          ...
          },
          {
            ...
            value: function () {
              ...
              var items = document.getElementsByClassName('body-content');
              if (!items.length)
                throw new Error('No .body-content element found');

              var size = items[0].getBoundingClientRect();

              (this.o.c = { w: size.width, h: size.height }),
